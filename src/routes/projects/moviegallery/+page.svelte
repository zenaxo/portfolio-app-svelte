...
<svelte:head>
    ...
    <meta name="description" content="The process of creating a movie gallery in ASP .NET MVC with database connection" />
    <meta
    ...
    <meta
        name="keywords"
        content="Hannes Sjölander, Movie Gallery, SQL, .NET, C#, MVC, Database"
    />
</svelte:head>
<div class="min-h-screen pt-[59px] flex flex-col items-center">
	<article class="my-16 max-w-[800px] mx-6">
		...
		<p class="text-secondary text-base text-justify">
			This project was part of the course <a href="https://www.umu.se/utbildning/kurser/databasteknik-och-webbaserade-system/" class="hover:underline italic">Databases and Web Based Systems</a> at Umeå University which focused on methods for storing and managing data with <span class="italic">ASP.NET MVC,</span> and <span class="italic">SQL</span>
			The application developed is a digital library for movies, allowing users to discover new releases and top-rated titles. Administrators have the capability to create, edit, and delete movie entries, while regular users can leave reviews.
		</p>
		...
		<div class="flex items-center justify-around gap-4 px-4 border-2 border-accentAlt p-4 rounded-md mb-4">
