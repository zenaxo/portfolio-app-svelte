...
<svelte:head>
    ...
    <meta name="description" content="The process of creating my professional portfolio with SvelteKit and Tailwind CSS" />
    <meta
        property="og:description"
        content="The process of creating my professional portfolio with SvelteKit and Tailwind CSS"
    />
    <meta property="og:url" content={`https://hannessjolander.com/projects/${props.title}`}/>
    <meta
        name="keywords"
        content="Hannes Sjölander, portfolio, Svelte, SvelteKit, TailwindCSS, Front-end, Design, UX"
    />
</svelte:head>
...
<div class="min-h-screen pt-[59px] flex flex-col items-center">
	<article class="my-16 max-w-[800px] mx-6">
		...
		<p class="text-secondary text-base text-justify mb-4">
        ...
        <p class="text-secondary text-base text-justify mb-4">
            One of the main features of using Svelte is the familiarty to vanilla JavaScript, combined with the intuitive routing, and the ease of creating reusable components.
            Tailwind CSS was chosen for this project to aviod clashing class names and to speed up the development, all though Svelte does solve this issue to a certain degree with the ability to define the styles inside of the component files. 
        </p>
		...
		<div class="flex items-center justify-around gap-4 px-4 border-2 border-accentAlt p-4 rounded-md mb-4 mt-8">
			...
			<button on:click={prevImg} class="p-2 ml-2 flex items-center justify-center relative" aria-label="Previous image">
				<svg
					...
					class="lucide lucide-arrow-left absolute hover:w-12 hover:h-12 text-secondary"><path d="m12 19-7-7 7-7" /><path d="M19 12H5" /></svg
				>
			</button>
			{/if}
			...
			<button on:click={nextImg} class="p-2 mr-2 flex items-center justify-center" aria-label="Next image">
				<svg
					...
					stroke-linecap="round"
					stroke-linejoin="round"
					class="lucide lucide-arrow-right absolute hover:w-12 hover:h-12 text-secondary"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg
				>
			</button>
			{/if}
		</div>
		<div class="flex text-secondary items-center gap-4">
			...
			<Button type="external" href={props.gitHubUrl} className="border-2 border-secondary text-secondary px-4 py-2 mobile:text-sm rounded transition-colors duration-250 shadow sm group flex items-center justify-center">
				<svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-brand-github group-hover:rotate-[30deg] transition-transform duration-250 w-[24px] mobile:w-[16px] aspect-square text-secondary"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 19c-4.3 1.4 -4.3 -2.5 -6 -3m12 5v-3.5c0 -1 .1 -1.4 -.5 -2c2.8 -.3 5.5 -1.4 5.5 -6a4.6 4.6 0 0 0 -1.3 -3.2a4.2 4.2 0 0 0 -.1 -3.2s-1.1 -.3 -3.5 1.3a12.3 12.3 0 0 0 -6.2 0c-2.4 -1.6 -3.5 -1.3 -3.5 -1.3a4.2 4.2 0 0 0 -.1 3.2a4.6 4.6 0 0 0 -1.3 3.2c0 4.6 2.7 5.7 5.5 6c-.6 .6 -.6 1.2 -.5 2v3.5" /></svg>
				<span>Code</span>
			</Button>
		</div>
	</article>
