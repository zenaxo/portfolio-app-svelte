...
<div class="my-24 flex flex-col items-center flex-1 gap-4">
	...
	<div class="flex my-auto mx-10 flex-1 justify-center">
		...
		{/if}
		<div
			class="justify-center mobile:w-[60vw] aspect-video max-w-[600px] h-full relative flex items-center"
		>
			<img
