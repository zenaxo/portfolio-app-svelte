...
<div
	class="flex h-[100dvh] relative border-b border-accentAlt hero overflow-hidden text-secondary section-start"
...
>
	...
	<!--Background end-->
	<div
		class="w-full pt-[59px] h-full max-h-full flex items-center justify-around z-30 mobile:flex-col"
	>
