...
<div
	class="w-full max-w-[1200px] h-[calc(100vh-58px)] italic flex flex-col text-8xl mobile:text-3xl pt-20 pl-20 pr-20 pb-20 mobile:pr-6 mobile:pl-6 justify-center font-semibold whitespace-nowrap"
	id="aboutContainer"
>
